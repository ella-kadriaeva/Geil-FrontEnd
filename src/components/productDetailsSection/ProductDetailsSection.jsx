...
const ProductSection = ({description, image, price, discont_percent, title}) => {
      ...
      <div className={styles.productCart}>
        ...
        <div className={styles.productInfoWrapper}>
          ...
          <div className={styles.flexWrapper}>
            ...
            {percent > 0 && (
              <p className={styles.productDiscountPrice}>&#36;{formatPrice(price)}</p>
            )}
            {percent > 0 && (
          ...
          <div className={styles.actionsWrapper}>
            <div className={styles.quantityControl}>
              <button type="button" className={styles.quantityBtn}>&#8722;</button>
          ...
          <div className={styles.productDescriptionWrapper}>
            ...
            <p className={styles.descriptionText}> {isExpanded ? description : `${description.slice(0, 200)}...`}</p>
            <span className={styles.moreBtn} onClick={toggleDescription}>{isExpanded ? "hide" : "Read more"}</span>
